...
class ShopList extends PolymerElement {
  static get template() {
    ...
    -->
     <!--<iron-ajax auto-->
               <!--url = "http://localhost:3000/api/v1/products.json?token=0ef005fa2a55a005a316ae0f40c424cae820f4804e5acad8"-->
               <!--params = "" handle-as = "json" on-response = "_handleResponse"-->
               <!--products="{{products}}"-->
  ...
  _getListItems(items) {
    // Return placeholder items when the items haven't loaded yet.
      console.log("rolando esse trem", items);
    return items || [{},{},{},{},{},{},{},{},{},{}];
  }
  ...
  _getItemHref(item) {
    ...
    _handleResponse(response){
        this.category.items[0].name = response.detail.response.products[0].name;
      console.log("response======> ",this.products, this.category.items[0], response.detail.response.products);
    }
